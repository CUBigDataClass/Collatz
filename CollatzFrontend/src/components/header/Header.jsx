...
const Header = () => {
  ...
  const callAPI = (event)=> {
    ...
    fetch(`http://34.83.14.233:80/users/flights/${window.username}?starting_loc=${travelFrom}&destination=${travelTo}&start_date=${leaveDate}&end_date=${returnDate}&adult_count=${travelerCount}&child_count=0`)
      .then(console.log("flights"))
    fetch(`http://34.83.14.233:80/users/places/${window.username}?starting_loc=${travelFrom}&destination=${travelTo}&start_date=${leaveDate}&end_date=${returnDate}&adult_count=${travelerCount}&child_count=0`)
      .then(console.log("places"))
    fetch(`http://34.83.14.233:80/users/rentals/${window.username}?starting_loc=${travelFrom}&destination=${travelTo}&start_date=${leaveDate}&end_date=${returnDate}&adult_count=${travelerCount}&child_count=0`)
      .then(console.log("rentals"))
    fetch(`http://34.83.14.233:80/users/recs/${window.username}?starting_loc=${travelFrom}&destination=${travelTo}&start_date=${leaveDate}&end_date=${returnDate}&adult_count=${travelerCount}&child_count=0`)    
